...
This contract is an ERC20 with additional minting and burning functionality restricted to the owner.

*This contract inherits from Openzeppelins ERC20 contract to implement ERC20 functionality. This contracts inherits from Openzeppelins Ownable contract to allow for controlled minting and burning of tokens by the owner. PoolToken implements the IPoolToken interface to extend its ERC20 functionality to allow for minting and burning of tokens*
...
*This function reverts if caller is not the owner*
